...
# ====== BẢNG THUẬT TOÁN (RÚT GỌN – MÀY THAY BẢNG FULL CỦA MÀY VÀO) ======
prediction_table = {
"TTTTTTTTTTTTT": "Tài",
"TTTTTTTTTTTTX": "Tài",
"TTTTTTTTTTTXT": "Xỉu",
...
"XXXXXXXXXXXXT": "Xỉu",
"XXXXXXXXXXXXX": "Xỉu",
    # ⚠️ dán FULL bảng của mày vào đây
}
...
def get_taixiu_data():
    ...
    try:
        ...
        # tạo chuỗi cầu T/X
        cau = ""
        for item in reversed(recent):  # cũ -> mới
        ...
        # độ tin cậy đơn giản theo độ dài cầu
        do_tin_cay = min(len(key) * 7, 98)
